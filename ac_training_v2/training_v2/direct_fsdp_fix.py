...
def create_direct_fsdp_train_state(
    ...
    from training_v2.acrlpd_train_state import ACRLPDTrainState, acrlpd_train_step
    ...
    def init_fn(rng: jax.Array, partial_params: Any = None) -> ACRLPDTrainState:
        ...
        if hasattr(agent, 'temperature_module') and agent.temperature_module:
            ...
            temp_tx = _optimizer.create_optimizer(rl_config.actor_optimizer, rl_config.actor_lr_schedule)
